...
def update_of_voeg_toe(cursor, naam, datum, categorie, locatie, afbeelding):
    ...
    if result:
        ...
        # Alleen updaten als de huidige opgeslagen datum in het verleden ligt
        if huidige_datum < datetime.date.today():
            ...
            print(f"Geüpdatet: {naam} doorgeschoven naar {nieuwe_datum_str}")
        else:
        ...
        print(f"Toegevoegd: {naam} gepland op {nieuwe_datum_str}")
...
def bereken_datums():
    ...
    try:
        ...
        update_of_voeg_toe(cursor, "Volle Maan", volgende_volle_maan, "cultuur", "Ruimte", "https://hoelangnogtot.nl/images/volle-maan.jpg")
        update_of_voeg_toe(cursor, "Nieuwe Maan", volgende_nieuwe_maan, "cultuur", "Ruimte", "https://hoelangnogtot.nl/images/nieuwe-maan.jpg")

        # 2. Eerste dag van de volgende maand
        eerste_volgende_maand = (vandaag.replace(day=1) + datetime.timedelta(days=32)).replace(day=1)
        update_of_voeg_toe(cursor, "Start Nieuwe Maand", eerste_volgende_maand, "cultuur", "Wereldwijd", "https://hoelangnogtot.nl/images/nieuwe-maand.jpg")

        # 3. Award Shows (historische patronen)
        # Oscars: Meestal de tweede zondag van maart
        ...
        # Grammys: Meestal de eerste zondag van februari
        ...
        # Tonys: Meestal de tweede zondag van juni
        ...
        # Emmys: Meestal de derde zondag van september
